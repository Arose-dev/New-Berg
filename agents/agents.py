...
class SignatureAgent(Agent):
    ...
    def __init__(
        self, predef_signatures, model_name=DEFAULT_TEXT_MODEL, write_results=True, headers=[]
    ):
...
class APIAgent(Agent):
    ...
    def __init__(
        self, signature_agent, dataset, model_name=DEFAULT_TEXT_MODEL, write_results=True, api=[]
    ):
        super().__init__(model_name, write_results)
...
class ProgramAgent(Agent):
    def __init__(
        self, api_agent, model_name=DEFAULT_TEXT_MODEL, write_results=True, dataset="clevr"
    ):
