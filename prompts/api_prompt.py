...
5) The surrounding pipeline targets text-only multiple-choice / true-false questions. Do not implement methods for image generation or any task whose output is another image.
