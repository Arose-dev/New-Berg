...
If the question is multiple choice or true/false, answer with ONLY the correct option letter (A, B, C, or D).
Do not describe or generate an image. Return only the answer label requested by the question.
